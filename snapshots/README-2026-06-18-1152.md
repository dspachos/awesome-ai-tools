...
> A curated, opinionated map of the **user-facing AI-tools landscape (as of 2026-06-18)** — CLI coding agents, OpenClaw-style "always-on" personal assistants, computer-use & browser agents, and agent frameworks / SDKs.
>
...
**46 tools** · **4 overlapping layers** · **Updated 2026-06-18**
...
- [Trending Repos Snapshot](#-trending-repos-snapshot--20260618)
- [This Week](#-this-week)
...
The clearest mental model: **the CLI coding agents are the substrate; the OpenClaw-style always-on personal assistants are the new application layer that orchestrates them.** As of 2026-06-18, the landscape has consolidated around four overlapping layers, with the headline story being a genuinely new product category — self-hosted, chat-reachable, persistent, proactive, computer-controlling assistants.

| # | Layer | Key fact | State of play |
|---|-------|----------|---------------|
| 1 | **CLI coding agents** | Table-stakes layer | Vendor CLIs (Claude Code, Codex, Gemini, Cursor, Copilot, Kiro) + OSS (Aider, Crush, Qwen Code, OpenCode ~176k★). Free-tier winner: Gemini CLI. Pricing converged on subscription-plus-credits. |
...
- **[Codex CLI](https://github.com/openai/codex)** ![active](https://img.shields.io/badge/active-brightgreen) — Sandboxed agentic execution; Rust rewrite. Bundled with ChatGPT plans or API-metered. Top vendor CLI on Terminal-Bench. · `Apache-2.0` · Rust · ≈91.7k★ *approx/unverified*
- **[Gemini CLI](https://github.com/google-gemini/gemini-cli)** ![active](https://img.shields.io/badge/active-brightgreen) — Best free tier of any vendor CLI (60 req/min, 1,000/day). Subagents + Plan mode. · `Apache-2.0` · TypeScript · ≈105k★ *approx/unverified*
...
- **[Aider](https://github.com/Aider-AI/aider)** ![active](https://img.shields.io/badge/active-brightgreen) — Maturest community OSS tool. Git-integrated pair-programming loop, repo map, auto-commits. Host of the widely-cited LLM coding leaderboard. · `Apache-2.0` · Python · ≈46.4k★ *approx/unverified*
...
- **[Qwen Code](https://github.com/QwenLM/qwen-code)** ![active](https://img.shields.io/badge/active-brightgreen) — Self-described Claude-Code feature-parity: subagents, agent teams, skills/hooks, MCP, plan mode, computer use. Pairs open model + open framework. · `Apache-2.0` · Node.js · ≈25.3k★ *approx/unverified*
- **[OpenCode](https://github.com/anomalyco/opencode)** ![active](https://img.shields.io/badge/active-brightgreen) — Highest-traction OSS terminal coding agent. Multi-session parallel agents, desktop beta. Copilot/OpenAI login. (Two 'OpenCode' lineages — see open questions.) · `OSS` · TypeScript · ≈176k★ *approx/unverified*

### AI-native terminals & legacy

- **[Warp](https://github.com/warpdotdev/warp)** ![active](https://img.shields.io/badge/active-brightgreen) — AI-native terminal — replaces the shell itself (NL→bash, block-based dev env), not a coding agent running inside one. · `Client AGPL-3.0 / server proprietary` · Rust · ≈37k★ *approx/unverified*
...
|---|---|---|---|
| **[OpenClaw](https://github.com/openclaw/openclaw)** ![active](https://img.shields.io/badge/active-brightgreen) | `MIT` · TypeScript, Swift | ≈370k★ *self-reported, approximate (~370k+)* | The reference open-source always-on personal assistant: self-hosted Gateway daemon, 20+ chat surfaces, markdown memory, 30-min heartbeats, self-hackable SKILL.… |
...
- **[Microsoft OmniParser v2](https://github.com/microsoft/OmniParser)** ![active](https://img.shields.io/badge/active-brightgreen) — Not an agent — pure-vision GUI-grounding module that 'tokenizes' screenshots. Paired with OmniTool (dockerized Win11 VM). · `OSS` · Python · ≈25k★ *approx/unverified*
- **[Simular Agent S3](https://github.com/simular-ai/Agent-S)** ![active](https://img.shields.io/badge/active-brightgreen) — First VENDOR-REPORTED OSWorld crossing: 72.60% (best-of-N; single-pass 66%). Not on independent leaderboards. Full desktop + Android. Raised $21.5M. · `Apache-2.0` · Python · ≈11.9k★ *approx/unverified*
- **[Browser Use](https://github.com/browser-use/browser-use)** ![active](https://img.shields.io/badge/active-brightgreen) — Widely-used OSS browser-agent library (Playwright). Rust-backed beta (0.13.0). Commercial 'Browser Use Box' = 24/7 Claude agent from Telegram/SSH (OpenClaw overlap). · `MIT` · Python · ≈99.3k★ *approx/unverified*
- **[Skyvern](https://github.com/Skyvern-AI/skyvern)** ![active](https://img.shields.io/badge/active-brightgreen) — Enterprise browser-RPA replacement. Planner-Agent-Validator, native CAPTCHA + 2FA, SOC2/HIPAA. Workflow engine, not chat-reachable. · `AGPL-3.0` · Python · ≈21.9k★ *approx/unverified*
- **[OpenHands](https://github.com/OpenHands/OpenHands)** ![active](https://img.shields.io/badge/active-brightgreen) — Self-hosted 'developer control center'. Runs its own agent OR Claude Code/Codex/Gemini. SDK + CLI + GUI + Agent Canvas (scheduled tasks, Slack/GitHub/Linear). · `MIT (core)` · Python · ≈77.5k★ *approx/unverified*
...
- **[OpenAI Agents SDK](https://github.com/openai/openai-agents-python)** ![active](https://img.shields.io/badge/active-brightgreen) — Productionized successor to Swarm. Agents, Sandbox Agents, Handoffs, Tools (fn/MCP/hosted), Guardrails, HITL, Sessions, Tracing, Realtime voice agents. · `MIT` · Python, JS/TS · ≈27.2k★ *approx/unverified*
...
- **[Anthropic Agent Skills](https://github.com/anthropics/skills)** ![active](https://img.shields.io/badge/active-brightgreen) — Reference impl of the Agent Skills standard (SKILL.md capability packs). Widely cited as having 'surged past MCP' as the de-facto capabilities layer. · `Apache-2.0 (skills)` · Markdown (SKILL.md) · ≈152k★ *approx/unverified*
- **[Google ADK 2.0](https://github.com/google/adk-python)** ![active](https://img.shields.io/badge/active-brightgreen) — Code-first build/eval/deploy. ADK 2.0 added graph-based Workflow Runtime (routing, fan-out/fan-in, loops, HITL) + Task API for agent-to-agent delegation. · `Apache-2.0` · Python, Go, Java, TS · ≈20.2k★ *approx/unverified (py)*
- **[Microsoft AutoGen](https://github.com/microsoft/autogen)** ![maintenance](https://img.shields.io/badge/maintenance-yellow) — MAINTENANCE MODE. Event-driven multi-agent. Users directed to Microsoft Agent Framework. · `CC-BY-4.0` · Python, .NET · ≈58.9k★ *approx/unverified*
- **[Microsoft Agent Framework](https://github.com/microsoft/agent-framework)** ![GA](https://img.shields.io/badge/GA-brightgreen) — 1.0 GA. Official successor merging AutoGen + Semantic Kernel. Graph workflows, durable/restartable, A2A + MCP interop. · `MIT` · Python, .NET · ≈11.4k★ *approx/unverified*

### Orchestration layer

- **[LangGraph](https://github.com/langchain-ai/langgraph)** ![GA](https://img.shields.io/badge/GA-brightgreen) — 1.0 GA Oct 2025. Low-level stateful/durable graph orchestration with first-class HITL interrupts + memory. Deep Agents harness on top. · `MIT` · Python, JS/TS · ≈35.1k★ *approx/unverified*
- **[CrewAI](https://github.com/CrewAIInc/CrewAI)** ![active](https://img.shields.io/badge/active-brightgreen) — Role-based Crews (autonomous agent teams) + deterministic Flows. Standalone since v1.14 (no LangChain dep). Fortune-500 traction claimed. · `MIT` · Python · ≈53.8k★ *approx/unverified*
- **[PocketFlow](https://github.com/The-Pocket/PocketFlow)** ![active](https://img.shields.io/badge/active-brightgreen) — Deliberately 100-line minimalist graph framework, zero dependencies. Positioned for 'let Cursor/Claude build agents on top.' · `MIT` · Python, TS, Java, C++, Go · ≈11k★ *approx/unverified*
- **[PydanticAI](https://github.com/pydantic/pydantic-ai)** ![beta](https://img.shields.io/badge/beta-orange) — 'FastAPI-feeling,' fully type-safe, model-agnostic. Tight OTel/Logfire observability. v2.0 beta. · `MIT` · Python · ≈17.8k★ *approx/unverified*
- **[smolagents](https://github.com/huggingface/smolagents)** ![active](https://img.shields.io/badge/active-brightgreen) — Agents that 'think in code' — CodeAgent writes Python (sandboxed via E2B/Modal/Docker) vs JSON ToolCallingAgent. ~1k-line core. · `Apache-2.0` · Python · ≈27.9k★ *approx/unverified*
- **[LlamaIndex](https://github.com/run-llama/llama_index)** ![active](https://img.shields.io/badge/active-brightgreen) — RAG-native 'document agent' platform. Multi-agent via AgentWorkflow + custom planners. · `MIT` · Python, TS · ≈50.2k★ *approx/unverified*

### Editor-agent runtimes & managed platforms

- **[Cline](https://github.com/cline/cline)** ![active](https://img.shields.io/badge/active-brightgreen) — Pioneer agentic VS Code extension, repositioned as ONE runtime across IDE + terminal + SDK (CLI 3.0 May 2026). 8M+ installs. · `Apache-2.0` · TypeScript · ≈63k★ *approx/unverified*
- **[Roo Code](https://github.com/RooCodeInc/Roo-Code)** ![archived](https://img.shields.io/badge/archived-lightgrey) — ARCHIVED May 15, 2026 (final v3.54.0). Cline fork w/ custom modes. Team pivoted to 'Roomote' (Slack-first cloud). Successors: Zoo Code, Kilo Code. · `Apache-2.0` · TypeScript · ≈24.2k★ *approx/unverified*
...
|---|---|---|---|
| [`openclaw/openclaw`](https://github.com/openclaw/openclaw) | ~370k | Always-on assistant | The reference open-source always-on personal assistant: self-hosted Gateway daemon, 20+ c… |
| [`anomalyco/opencode`](https://github.com/anomalyco/opencode) | ~176k | CLI coding agent | Highest-traction OSS terminal coding agent. Multi-session parallel agents, desktop beta. … |
| [`anthropics/skills`](https://github.com/anthropics/skills) | ~152k | Agent framework / SDK | Reference impl of the Agent Skills standard (SKILL.md capability packs). Widely cited as … |
| [`google-gemini/gemini-cli`](https://github.com/google-gemini/gemini-cli) | ~105k | CLI coding agent | Best free tier of any vendor CLI (60 req/min, 1,000/day). Subagents + Plan mode. |
| [`browser-use/browser-use`](https://github.com/browser-use/browser-use) | ~99.3k | Computer-use / browser | Widely-used OSS browser-agent library (Playwright). Rust-backed beta (0.13.0). Commercial… |
| [`openai/codex`](https://github.com/openai/codex) | ~91.7k | CLI coding agent | Sandboxed agentic execution; Rust rewrite. Bundled with ChatGPT plans or API-metered. Top… |
| [`OpenHands/OpenHands`](https://github.com/OpenHands/OpenHands) | ~77.5k | Computer-use / browser | Self-hosted 'developer control center'. Runs its own agent OR Claude Code/Codex/Gemini. S… |
| [`cline/cline`](https://github.com/cline/cline) | ~63k | Agent framework / SDK | Pioneer agentic VS Code extension, repositioned as ONE runtime across IDE + terminal + SD… |
| [`microsoft/autogen`](https://github.com/microsoft/autogen) | ~58.9k | Agent framework / SDK | MAINTENANCE MODE. Event-driven multi-agent. Users directed to Microsoft Agent Framework. |
| [`CrewAIInc/CrewAI`](https://github.com/CrewAIInc/CrewAI) | ~53.8k | Agent framework / SDK | Role-based Crews (autonomous agent teams) + deterministic Flows. Standalone since v1.14 (… |
...
| [`Aider-AI/aider`](https://github.com/Aider-AI/aider) | ~46.4k | CLI coding agent | Maturest community OSS tool. Git-integrated pair-programming loop, repo map, auto-commits… |
...
- **OpenClaw shipped a broad stability + operator-trust release** `(major) · `openclaw` — v2026.6.8 went stable: richer Telegram/WhatsApp delivery, a sweeping agent+gateway recovery sweep, GLM-5.2 + Claude Haiku 4.5 model support, and — notably — npm package verification + release evidence (integrity hashes, signed/notarized macOS assets). The trend is toward 'safe to upgrade in production,' not just new features.
- **No new category entrants this week** `(minor) — The OpenClaw-style always-on-assistant category stayed at its known set (OpenClaw, Memoh, OwnPilot, Lethe). Watch for new entrants next cycle.

**What to watch:**
- **Operator-grade hardening across the category** (next 2-4 weeks) — OpenClaw's release-evidence push (integrity hashes, signed assets) signals the category is maturing from 'hobby script' to 'production runtime.' Expect peers and proprietary answers to follow with equivalent trust/verification stories.
- **The 'skills' standardization race** (ongoing) — Anthropic Agent Skills (~152k★) is converging with OpenClaw SKILL.md and Cline/Cursor/Google formats. Whichever becomes the de-facto interop layer determines portability of agent capabilities across tools.
- **Fable 5 / Mythos 5 suspension fallout** (confirm primary source) — If the reported US-government suspension of these Claude models holds, OSWorld-Verified leaderboard claims referencing them become non-reproducible — affects how computer-use 'parity' is reported.
...
- Exact OpenClaw star/fork/last-commit counts — re-pull from GitHub API before hard citation.
...
- Fable 5 / Mythos 5 reportedly government-suspended (mid-June 2026) — confirm primary source.
- OSWorld aggregator disagreement (75% / 83.4% / 85% across three trackers) — unresolved.
