...
- **Star counts are popularity, not quality** — point-in-time snapshots that drift within days. 29 of 32 tracked repos were verified directly from the GitHub API on 2026-06-19; the remainder are marked *unverified* (pulled from tracker/repo pages, not re-pulled).
